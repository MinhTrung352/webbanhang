...
<!-- Nav tabs -->
	...
	<?php
		$layout = array('id' => 'page_layout', 'title' => 'Page Layout', 'default'=> '0-1-0');
    ...
    ?>
		...
		<p class="wpo_section">
    	<?php
	    	$footer = wpo_get_footerbuilder_profiles();
	    	$data = array(array( 'id' => 'global', 'name' => 'Use Global'));
	    	...
	    	$mb->getSelectElement( $footer_style );
    	?>
	    </p>
		 <!--Show Breadcrumb config -->
        <p class="wpo_section show_breadcrumb">
        <?php
            $_show_breadcrumb = array('id'=>'breadcrumb', 'title'=>'Show Breadcrumb', 'default'=>'yes');
        ...
        <?php 
            $_show_title = array('id'=>'showtitle','title'=>'Show title header', 'default'=>'yes');
