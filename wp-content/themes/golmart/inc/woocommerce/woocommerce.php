	...
	class WPO_Woocommerce{
		...
		?>
			<ul class="display pull-right">
                ...
                <li>
                	<a style="position:relative;" data-query='<?php echo esc_attr($stringquery); ?>' data-type="list" <?php echo (($layout=='list')?'class="active"':''); ?> href="#">
                		<i class="fa fa-th-list"></i><span><?php echo __('List',TEXTDOMAIN); ?></span>
                	</a>
                </li>
                <li>
                	<a style="position:relative;" data-query='<?php echo esc_attr($stringquery); ?>' data-type="grid" <?php echo (($layout=='grid')?'class="active"':''); ?> href="#">
