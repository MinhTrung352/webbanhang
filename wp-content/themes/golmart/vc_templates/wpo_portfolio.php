...
$portfolio_skills = get_terms('category_portolio',array('orderby'=>'id'));
$args = array(
  'post_type' => 'portfolio',
...
<div class="widget-portfolio wpb_grid wpo-portfolio <?php echo (($el_class!='')?' '.$el_class:''); ?>">
    ...
    <div class="teaser_grid_container">
      <div class="wpb_filtered_grid teaser_grid_container">
          ...
          <ul class="nav nav-tabs wpo-portfolio-filters categories_filter">
            ...
            if( !empty($terms) && !is_wp_error($terms) ){
              foreach ( $terms as $term ) {
                echo '<li><a href="javascript:void(0)"  data-filter=".'.$term->slug.'">'.esc_attr( $term->name ).'</a></li>';
              }
            }
            ?>
          </ul>
        ...
        <div class="isotope-list row wpb_thumbnails wpb_thumbnails-fluid clearfix list-unstyled" data-isotope-duration="400" id="isotope-<?php echo esc_attr($_id); ?>">
         ...
         $item_classes = 'all ';
         $item_cats = get_the_terms( $loop->post->ID, 'category_portolio' );
         ...
         ?>
         <div class="isotope-item col-sm-<?php echo esc_attr($class_column); ?> item col-md-<?php echo esc_attr($class_column); ?> col-lg-<?php echo esc_attr($class_column); ?> <?php echo esc_attr($item_classes); ?>">
