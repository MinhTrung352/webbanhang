...
?>
	<div class="widget widget-<?php echo esc_attr($style); ?> widget-products widget-product-tabs products <?php echo (($el_class!='')?' '.$el_class:''); ?>">
		<div class="<?php echo esc_attr($style_tab); ?> tabs-container tab-heading text-center clearfix">
			<?php if($title!=''):?>
