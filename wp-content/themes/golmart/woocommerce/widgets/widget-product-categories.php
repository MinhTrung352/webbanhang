...
class WPO_Widget_Product_Categories extends WC_Widget_Product_Categories {
	...
	public function widget( $args, $instance ) {
			...
			<script type='text/javascript'>
				...
				function onProductCatChange() {
					if ( product_cat_dropdown.options[product_cat_dropdown.selectedIndex].value !=='' ) {
						location.href = "<?php echo esc_js( home_url() ); ?>/?product_cat="+product_cat_dropdown.options[product_cat_dropdown.selectedIndex].value;
					}
				}
		...
		// List
			...
			echo '<ul class="list-group-highlighted product-categories">';
