...
if( !(wpo_theme_options('wc_show_related', false)) ){
	if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly
		...
		if ( $products->have_posts() ) : ?>
			...
			<div class="widget widget-related-products widget-products products product-single no-margin">
				<div class="background"></div>
				<h3 class="widget-title visual-title">
			        <span><span><?php _e( 'Related Products', 'woocommerce' ); ?></span></span>
				</h3>
				<div class="woocommerce">
					<div class="widget-content <?php echo isset($style) ? esc_attr( $style ): ''; ?>"><div class="grid-wrapper">
