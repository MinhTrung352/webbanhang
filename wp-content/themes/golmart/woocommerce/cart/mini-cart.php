...
<?php if ( sizeof( WC()->cart->get_cart() ) > 0 ) : ?>
	...
	<p class="buttons">
		<a href="<?php echo WC()->cart->get_cart_url(); ?>" class="btn btn-outline btn-danger btn-sm wc-forward"><?php _e( 'View Cart', 'woocommerce' ); ?></a>
		<a href="<?php echo WC()->cart->get_checkout_url(); ?>" class="btn btn-outline btn-danger btn-sm checkout wc-forward"><?php _e( 'Checkout', 'woocommerce' ); ?></a>
	</p>
<?php endif; ?>
