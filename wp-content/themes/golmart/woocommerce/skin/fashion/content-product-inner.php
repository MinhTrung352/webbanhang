...
?>
<div class="text-center product product-grid product-block style-fashion">
	<figure class="image">
                ...
                <div class="action-bottom-wrap">
                    ...
                    <?php if(wpo_theme_options('is-quickview', true)){ ?>
                        <div class="quick-view">
                            <a href="#" class="quickview btn-action btn-outline-inverse" data-productslug="<?php echo trim($product->post->post_name); ?>" data-toggle="modal" data-target="#wpo_modal_quickview">
