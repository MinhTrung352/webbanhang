...
<body <?php body_class(); ?>>
    ...
    <section class="wpo-wrapper <?php echo isset($meta_template['el_class']) ? $meta_template['el_class'] : '' ; ?>">
        ...
        <!-- Top bar -->
        <section id="wpo-topbar" class="wpo-topbar skin-cd market-v2">
        ...
        <!-- // Topbar -->
        <!-- HEADER -->
        <header id="wpo-header" class="wpo-header skin-cd market-v2">
                    ...
                    <div class="container">
                        <div class="mainmenu-content"> 
                            <div class="row">
                                ...
                                <?php 
                                $is_header_center = is_active_sidebar('header-market-center');
                                if(is_active_sidebar('header-market-center')){?>
                                    <div class="col-md-5">
                                        <div class="header-center">
                                            <?php dynamic_sidebar('header-market-center'); ?>
                                        </div>
                                    </div>
                                <?php } ?>
                                <div class="hidden-sm hidden-xs <?php echo ($is_header_center ) ? 'col-md-1 no-fullsearch':' col-md-6'; ?>">
                                    <div class="search">
                                        <?php get_search_form(); ?>
                                    </div>
                                </div>
                                <?php if( WPO_WOOCOMMERCE_ACTIVED ) { ?>
                                    ...
                                    <?php if( wpo_theme_options('woo-show-minicart', true) ) : ?>
                                        <div class="top-cart col-md-3 pull-right hidden-sm hidden-xs">
                                            <div class="top-cart-inner clearfix">
                            ...
                            <div class="p-relative">
                                <div class="row">
                                    <?php
                                     ...
                                     if($is_vertical){  
                                    ?>
                                        <div class="col-md-3 inside-navigation  menu-vertical-hidden hidden-sm hidden-xs">
                                            <?php dynamic_sidebar('vertical-menu'); ?>
                                        </div>
                                    <?php } ?>

                                    <div class="<?php echo (($is_vertical)?'col-md-9 p-static':'col-md-12'); ?>">
                                        <nav id="wpo-mainnav" data-duration="<?php echo wpo_theme_options('megamenu-duration',400); ?>" class="pull-left p-static wpo-megamenu <?php echo wpo_theme_options('magemenu-animation','slide'); ?> animate navbar navbar-mega" role="navigation">
