...
<body <?php body_class(); ?>>
    ...
    <section class="wpo-wrapper <?php echo isset($meta_template['el_class']) ? $meta_template['el_class'] : '' ; ?>">
        ...
        <!-- Top bar -->
        <section id="wpo-topbar" class="wpo-topbar skin-cd market-v1">
        ...
        <!-- // Topbar -->
        <!-- HEADER -->
        <header id="wpo-header" class="wpo-header skin-cd market-v1">
                ...
                <div class="wpo-mainmenu-header">
                    <div class="container">
                        <div class="mainmenu-content"> 
                            <!-- LOGO -->
                            <div class="logo-in-theme col-md-3 no-padding pull-left">
                    ...
                    <div class="main-search hidden-sm hidden-xs">
                        <div class="container">
                            <div class="row">
                                    <?php
