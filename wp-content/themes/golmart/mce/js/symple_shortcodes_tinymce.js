		...
		render : function(ed, title, id) {
			ed.add({
				...
				onclick: function () {
					...
					if(id == "half") {
						tinyMCE.activeEditor.selection.setContent('[col_6 class="" ]<br />' + sympleDummyContent + '<br />[/col_6]');
					}

					if(id == "third") {
						tinyMCE.activeEditor.selection.setContent('[col_4 class="" ]' + sympleDummyContent + '[/col_4]');
					}
					if(id == "fourth") {
						tinyMCE.activeEditor.selection.setContent('[col_3 class="" ]' + sympleDummyContent + '[/col_3]');
					}
					if(id == "sixth") {
						tinyMCE.activeEditor.selection.setContent('[col_2 class="" ]' + sympleDummyContent + '[/col_2]');
					}
					if(id == "one_full") {
