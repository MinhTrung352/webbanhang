				...
				<ul class="slides">
					<?php foreach ( $images as $image ): ?>
						<li>
							...
							<img src="<?php echo esc_url_raw($imageid[0]); ?>" alt="<?php echo esc_attr( $image->post_title ); ?>">
							
							<?php if ( $image->post_excerpt ): ?>
								<div class="image-caption"><?php echo trim($image->post_excerpt); ?></div>
							<?php endif; ?>
						</li>
					<?php endforeach; ?>
				</ul>
	...
	<div class="post-format">	
		<?php 
			if ( isset($meta['_video_url'][0]) && !empty($meta['_video_url'][0]) ) {
				...
				echo trim($meta['_video_embed_code'][0]);
				echo '</div>';
			}
		?>	
	</div>
